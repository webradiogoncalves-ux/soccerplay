...
function App(){
  ...
  function speak(text){
    ...
    const u=new SpeechSynthesisUtterance(text); u.lang="pt-BR";u.rate=.8;u.pitch=1.05;u.volume=1;
    window.speechSynthesis.speak(u);
  }
  function activateVoice(){
    if(!("speechSynthesis" in window)){setError("Voz não disponível neste aparelho.");return}
    setVoice(true);voiceRef.current=true;try{localStorage.setItem("soccerplay:goalvoice","1")}catch{}
    speak("Notificações de gol ativadas");
  }
